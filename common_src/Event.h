...
enum EventType: char {TOGGLE_MOVEMENT, SET_ANGLE, TOGGLE_WEAPON, RELOAD_WEAPON, CHANGE_WEAPON, BUY_WEAPON, DROP_WEAPON, TOGGLE_DEFUSE, CREATE_GAME, JOIN_GAME, LIST_GAMES};
